...
const services = [
  { title: "Corporate Training", href: "/services/corporate-training" },
  { title: "Technology Training", href: "/services/technology-training" },
  { title: "Compliance & Risk Training", href: "/services/compliance-training" },
  { title: "Leadership & Capability Building", href: "/services/leadership-training" },
  { title: "Custom Programs", href: "/services/custom-programs" },
];

const industries = [
  { title: "IT & Technology", href: "/industries/it-technology" },
  { title: "BFSI", href: "/industries/bfsi" },
      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3">
            <img src={logo} alt="RYT Global" className="h-14 w-auto" />
          </Link>
                    ...
                    <ul className="grid w-[400px] gap-1 p-4 bg-white">
                      ...
                      <li className="border-t mt-2 pt-2">
                        <NavigationMenuLink asChild>
                          <Link
                            to="/services"
                            className="block select-none rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent/10 hover:text-accent font-medium text-sm"
                          >
                            View All Services →
                          </Link>
                        </NavigationMenuLink>
                ...
                <NavigationMenuItem>
                  <Link to="/trainers">
                    <NavigationMenuLink
                      className={cn(
                        "px-4 py-2 text-sm font-medium transition-colors hover:text-accent",
                        isActive("/trainers") ? "text-accent" : "text-foreground"
                      )}
                    >
                      Trainers
                    </NavigationMenuLink>
